...
def create_case_session(tenant_id: str, created_by: str, case_id: Optional[str] = None) -> CaseSession:
    """
    ...
    """
    if case_id:
        session = CaseSession(case_id=case_id, tenant_id=tenant_id, created_by=created_by)
    else:
