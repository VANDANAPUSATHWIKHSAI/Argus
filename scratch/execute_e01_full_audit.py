"""
ARGUS E01 Real-Evidence Extraction & Pipeline Audit
===================================================
Executes Phase 1 through Phase 9 on:
2020JimmyWilson.E01
(C:\\Users\\Sudeep\\Downloads\\Argus\\raw evidence\\phase a\\disk 2\\2020JimmyWilson.E01)

Verifies every phase, outputs representative sample evidence, and checks forensic provenance.
"""
...
def main():
    ...
    print("=" * 80, flush=True)
    print("  ARGUS FORENSIC PIPELINE — REAL DISK IMAGE E01 AUDIT", flush=True)
    ...
    # Create Evidence object targeting the real evidence host file directly
    ...
    # Compute SHA-256 directly on disk image without duplicate disk copy
    import hashlib
    ...
    print(f"  TSK Command  : {rf.get('tsk_command')}", flush=True)
    ...
    print(f"Sample Norm Raw Fields   : {sample_norm.raw_fields}", flush=True)
